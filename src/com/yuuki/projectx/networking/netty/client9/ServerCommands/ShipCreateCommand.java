...
import com.yuuki.projectx.networking.netty.client9.ServerCommands.classPackets.class_365;
...
public class ShipCreateCommand
    ...
    public ShipCreateCommand(int pMapEntityId, String pShipLootId, int pExpansionStage, String pClanTag,
                             ...
                             int pRankId, boolean warnIcon, ClanRelationModule param12, int param13, boolean param14,
